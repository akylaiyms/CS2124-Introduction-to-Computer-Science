...
struct Game {
    ...
    mutating func playRound() -> Int{
        ...
        print("Player#1 - please enter the index of a card you want to play: ")
        let player1Index = Int(readLine() ?? "0") ?? 0
        
        print("Player#2 - please enter the index of a card you want to play: ")
        ...
        let player1Attack = player1Card.calculateAttack(opposingCard: player2Card)
        let player2Attack = player2Card.calculateAttack(opposingCard: player1Card)
        ...
        print("-----------")
        print("POINTS (1 and 2): ", self.player1.points, " - ", self.player2.points)
        print("-----------")
